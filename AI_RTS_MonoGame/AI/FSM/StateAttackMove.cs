...
namespace AI_RTS_MonoGame.AI.FSM
{
    class StateAttackMove : UnitFSMState
    {
        ...
        public StateAttackMove(UnitController controller, GameplayManager gm) : base(FSMStates.AttackMove, controller,gm) { }

        public override void Enter()
        {
            controller.SetSteering(new FollowPath(gm, controller.ControlledUnit, controller.PathToFollow));
        }
